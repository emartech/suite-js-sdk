...
describe('ApiRequest', function() {
  ...
  describe('#get', function() {
    ...
    it('should call suite request\'s get', function(done) {
      ...
      var getApiRequest = this.sandbox.stub(SuiteRequest.prototype, 'get').callsFake(function() {
    ...
    it('should throw the sdk error if something went wrong', function(done) {
      ...
      this.sandbox.stub(SuiteRequest.prototype, 'get').callsFake(function() {
    ...
    it('should use the appropriate keys from the given options object', function(done) {
      ...
      this.sandbox.stub(SuiteRequest.Options, 'createForInternalApi').returns({});
    ...
    describe('with caching enabled', function() {
      ...
      it('should return cached result after the first request', function(done) {
        this.sandbox.stub(SuiteRequest.prototype, 'get')
  ...
  describe('#post', function() {
    ...
    it('should call suite request\'s post', function(done) {
      ...
      var postApiRequest = this.sandbox.stub(SuiteRequest.prototype, 'post').callsFake(function() {
        return getPromiseResolvesWith(promiseRespond);
      });
    ...
    it('should throw the sdk error if something went wrong', function(done) {
      ...
      this.sandbox.stub(SuiteRequest.prototype, 'post').callsFake(function() {
        return getPromiseRejectsWith(promiseError);
      });
  ...
  describe('#put', function() {
    ...
    it('should call suite request\'s put', function(done) {
      ...
      var putApiRequest = this.sandbox.stub(SuiteRequest.prototype, 'put').callsFake(function() {
        return getPromiseResolvesWith(promiseRespond);
      });
    ...
    it('should throw the sdk error if something went wrong', function(done) {
      var promiseError = new Error('yoError');
      this.sandbox.stub(SuiteRequest.prototype, 'put').callsFake(function() {
        return getPromiseRejectsWith(promiseError);
      });
      var request = new Request({});
  ...
  var assertRequestMethodCalledWithEncodedCustomerName = function(requestMethod, done) {
    var apiRequest = this.sandbox.stub(SuiteRequest.prototype, requestMethod).callsFake(function() {
      return getPromiseResolvesWith({});
    });
  ...
  var testRequestOptionSetupConstructorParameter = function(requestMethod, done) {
    ...
    this.sandbox.stub(SuiteRequest.prototype, requestMethod).callsFake(function() {
      return getPromiseResolvesWith({});
    });
    this.sandbox.stub(SuiteRequest.Options, 'createForInternalApi').returns({});
